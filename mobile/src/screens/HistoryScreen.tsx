...
import { listConsultationHistory } from "../lib/api";
...
const styles=StyleSheet.create({
 ...
 item:{backgroundColor:"#fff",borderRadius:20,padding:16},row:{flexDirection:"row",justifyContent:"space-between",gap:10},itemName:{fontSize:13,fontWeight:"800",color:C.text},date:{fontSize:9,color:C.muted},meta:{fontSize:10,color:C.muted,marginTop:7},
